...
std::vector<double> compute_gradient(const std::vector<std::string> &gradient, const std::map<std::string, double>& x) {
...
std::vector<double> negate(const std::vector<double> &grad) {
...
std::vector<double> matrix_multiply(const std::vector<std::vector<double>>& A, std::map<std::string, double> x) {
    std::vector<double> res;
    for (auto &i : A) {
        double sum = 0;
        auto it = x.begin();
...
std::map<std::string, double> matrix_sum(const std::map<std::string, double>& x1, std::vector<double> x2) {
...
std::vector<double> const_multiply(double constant, const std::vector<double>& p) {
    std::vector<double> res;
    res.reserve(p.size());
    for (double i : p) {
